...
- [`LdtkEntity`](https://docs.rs/bevy_ecs_ldtk/0.10.1/bevy_ecs_ldtk/app/trait.LdtkEntity.html) <!-- x-release-please-version -->
- [`LdtkIntCell`](https://docs.rs/bevy_ecs_ldtk/0.10.1/bevy_ecs_ldtk/app/trait.LdtkIntCell.html) <!-- x-release-please-version -->
