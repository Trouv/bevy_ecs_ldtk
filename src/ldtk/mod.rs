...
//!     modules.
//! 12. All urls in docs have been changed to hyperlinks with `<>`
//! 13. `Reflect` has been derived for [Type].
...
#[derive(
    Copy, Clone, Debug, Default, Eq, PartialEq, Serialize, Deserialize, Reflect
)]
...
pub struct LayerDefinition {
    ...
    #[serde(rename = "uiColor", with = "color::optional")]
...
#[derive(
    Clone, Debug, Default, PartialEq, Serialize, Deserialize, Component, Reflect
)]
