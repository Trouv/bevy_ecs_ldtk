...
//! [`bevy_ecs_ldtk` book](https://trouv.github.io/bevy_ecs_ldtk/v0.11.0). <!-- x-release-please-version -->
//!
...
//! [github repository](https://github.com/Trouv/bevy_ecs_ldtk/tree/v0.11.0/examples). <!-- x-release-please-version -->
//!
//! ## Feature flags
//!
